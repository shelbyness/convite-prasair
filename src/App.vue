...
<template>
  ...
  <div v-if="step === 2" class="container">
    ...
    <h3>Agora dê o seu jeito e decida pra onde iremos e o que faremos, pois minha parte eu já fiz: te convidei pra me levar pra sair 🙄</h3>
